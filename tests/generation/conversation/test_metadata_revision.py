...
from app.generation.conversation.service import refresh_metadata_from_turn
from app.generation.conversation.store import create_session
...
def test_technology_replacement(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("app.generation.conversation.service.update_metadata_llm", fake_update)
