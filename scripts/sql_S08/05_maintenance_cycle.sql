...
-- ============================================================
--
-- Contexto del directo: acabamos de insertar chunks adicionales para simular
-- el crecimiento del corpus (p. ej. re-ejecutar ingest_corpus.py o insertar
-- filas sintéticas durante el ensayo). Ahora toca el ciclo que mantiene la
-- BBDD vectorial sana en producción.
--
...
-- Tras una carga grande, last_analyze estará desfasado.
...
-- Requiere haber creado el índice halfvec en 03_create_halfvec.sql.
